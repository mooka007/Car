                ...
                <div className="flex flex-row w-full">
                    ...
                    <div className='hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
                        ...
                        <div className='space-y-5'>
                            ...
                            {/* <button
                            classNameName="inline-block flex-none px-4 py-3 border-2 rounded-lg font-medium border-black bg-black text-white">Create
                            account here</button> */}
                            <button className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">
                                    <a href="/register" className="hover:text-gray900">Create account here</a>
                                    </button>
                        </div>
                        <p className="font-medium">2024 © All rights reserved.  Made with ❤︎ </p>
                    </div>
                    {/*  form o footer - right side */}
                    <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
                        ...
                        {/*  login box */}
                        <div className="flex flex-1 flex-col  justify-center space-y-5 lg:w-[640px] lg:mt-20">
                            {/* text */}
                            <div className="flex flex-col space-y-2 text-center">
                                ...
                                {/* form */}
                            <form onSubmit={handleSubmit} className="flex flex-col max-w-md space-y-5 lg:ml-24">
