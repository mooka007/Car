...
const HeroSection = () => {
    ...
    return(
        ...
        <div className="bg-neutralSilver relative   flex items-center  n justify-center overflow-hidden z-50 mt-20">
            <div className="relative mx-auto h-full px-4 mt-20 pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
                            ...
                            <div className="mt-10 flex flex-col items-center md:flex-row">
                                ...
                                <a href="/" aria-label="" className="group inline-flex items-center font-semibold text-g1">Watch how
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" className="ml-4 h-6 w-6 transition-transform group-hover:translate-x-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                        <path strokeLinejoin="round"  d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
